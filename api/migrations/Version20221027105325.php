 ...
 */
final class Version20221027105325 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE certification (id INT NOT NULL, engineer_id INT NOT NULL, title VARCHAR(255) NOT NULL, company_name VARCHAR(255) NOT NULL, start_date DATE NOT NULL, end_date DATE DEFAULT NULL, current BOOLEAN NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_6C3C6D75F8D8CDF1 ON certification (engineer_id)');
        $this->addSql('CREATE TABLE client (id INT NOT NULL, user_ref_id INT NOT NULL, name VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, presentation TEXT DEFAULT NULL, country VARCHAR(255) DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, phone VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_C744045544E55A94 ON client (user_ref_id)');
        $this->addSql('CREATE TABLE domain (id INT NOT NULL, title VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE engineer (id INT NOT NULL, user_ref_id INT NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, experience INT DEFAULT NULL, day_rate INT DEFAULT NULL, presentation TEXT DEFAULT NULL, country VARCHAR(255) DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, phone VARCHAR(255) DEFAULT NULL, photo VARCHAR(255) DEFAULT NULL, gender VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_94176AD944E55A94 ON engineer (user_ref_id)');
        $this->addSql('CREATE TABLE experience (id INT NOT NULL, engineer_id INT NOT NULL, title VARCHAR(255) NOT NULL, company_name VARCHAR(255) NOT NULL, start_date DATE NOT NULL, end_date DATE DEFAULT NULL, current BOOLEAN NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_590C103F8D8CDF1 ON experience (engineer_id)');
        $this->addSql('CREATE TABLE mission (id INT NOT NULL, client_id INT NOT NULL, title VARCHAR(255) NOT NULL, description TEXT NOT NULL, budget NUMERIC(10, 3) NOT NULL, start_date DATE NOT NULL, end_date DATE NOT NULL, affected BOOLEAN NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_9067F23C19EB6921 ON mission (client_id)');
        $this->addSql('CREATE TABLE quote (id INT NOT NULL, engineer_id INT NOT NULL, mission_id INT NOT NULL, proposed_price NUMERIC(10, 3) NOT NULL, number_of_days INT NOT NULL, start_at DATE NOT NULL, date TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, confirmed BOOLEAN NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE study (id INT NOT NULL, engineer_id INT NOT NULL, title VARCHAR(255) NOT NULL, university VARCHAR(255) NOT NULL, start_date DATE NOT NULL, end_date DATE DEFAULT NULL, current BOOLEAN NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_E67F9749F8D8CDF1 ON study (engineer_id)');
        $this->addSql('CREATE TABLE sub_domain (id INT NOT NULL, domain_id INT NOT NULL, title VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
